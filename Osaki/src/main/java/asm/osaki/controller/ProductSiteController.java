...
public class ProductSiteController {
    ...
    public String filterByPrice(@RequestParam(name = "sort") Optional<String> sort, 
    		@RequestParam(name = "minPrice", required = false) Optional<String> minPrice, 
    		@RequestParam(name = "maxPrice", required = false) Optional<String> maxPrice, Model model, 
    		@RequestParam(name = "page", defaultValue = "0") int page, @RequestParam(name = "size", defaultValue = "100") int size) {
    ...
    public String filterflashSale(Model model, 
